...
public static class TileRenderer
{
    public static BaseShape Tessellate(this MapFeatureData feature, ref BoundingBox boundingBox, ref PriorityQueue<BaseShape, int> shapes)
    {
        ...
        if (feature.Properties.highway != Props.Highway.unset && feature.Properties.highway != Props.Highway.other)
        {
        ...
        else if (feature.Properties.water != Props.Water.Unset && feature.Type != GeometryType.Point)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.Properties.railway != Props.Railway.UNSET)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.Properties.natural != Props.Natural.UNSET && featureType == GeometryType.Polygon)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.Properties.boundary == Props.Boundary.Forest)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.Properties.landuse == Props.Landuse.FOREST || feature.Properties.landuse == Props.Landuse.ORCHARD)
        {
            var coordinates = feature.Coordinates;
            var geoFeature = new GeoFeature(coordinates, GeoFeature.GeoFeatureType.Forest);
            baseShape = geoFeature;
        ...
        else if (feature.Type == GeometryType.Polygon && (feature.Properties.landuse == Props.Landuse.RESIDENTIAL || feature.Properties.landuse == Props.Landuse.CEMETERY || feature.Properties.landuse == Props.Landuse.INDUSTRIAL ||
          feature.Properties.landuse == Props.Landuse.COMMERCIAL || feature.Properties.landuse == Props.Landuse.SQUARE || feature.Properties.landuse == Props.Landuse.CONSTRUCTION ||
          feature.Properties.landuse == Props.Landuse.MILITARY || feature.Properties.landuse == Props.Landuse.QUARRY || feature.Properties.landuse == Props.Landuse.BROWNFIELD))
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.Properties.landuse == Props.Landuse.FARM || feature.Properties.landuse == Props.Landuse.MEADOW || feature.Properties.landuse == Props.Landuse.GRASS ||
          feature.Properties.landuse == Props.Landuse.GREENFIELD || feature.Properties.landuse == Props.Landuse.RECREATION_GROUND || feature.Properties.landuse == Props.Landuse.WINTER_SPORTS ||
          feature.Properties.landuse == Props.Landuse.ALLOTMENTS)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.Properties.landuse == Props.Landuse.RESERVOIR || feature.Properties.landuse == Props.Landuse.BASIN)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.Type == GeometryType.Polygon && feature.Properties.building != Props.Building.UNSET)
        {
            var coordinates = feature.Coordinates;
            var geoFeature = new GeoFeature(coordinates, GeoFeature.GeoFeatureType.Residential);
            baseShape = geoFeature;
        ...
        else if (feature.Type == GeometryType.Polygon && feature.Properties.leisure != Props.Leisure.UNSET)
        {
            var coordinates = feature.Coordinates;
            var geoFeature = new GeoFeature(coordinates, GeoFeature.GeoFeatureType.Residential);
            baseShape = geoFeature;
        ...
        else if (feature.Type == GeometryType.Polygon && feature.Properties.amenity != Props.Amenity.UNSET)
        {
            var coordinates = feature.Coordinates;
            var geoFeature = new GeoFeature(coordinates, GeoFeature.GeoFeatureType.Residential);
            baseShape = geoFeature;
